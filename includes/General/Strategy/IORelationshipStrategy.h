#ifndef INVEK_SYSTEMS__STRATEGY__IO_RELATIONSHIP_STRATEGY_H
#define INVEK_SYSTEMS__STRATEGY__IO_RELATIONSHIP_STRATEGY_H
  ...
  namespace General {
    namespace Strategy {
      template <
        class ITEM,
        class ITEM_IN = ITEM,
        class ITEM_OUT = ITEM_IN> class IORelationshipStrategy :
      ...
      public:
        void addInputRelationship (std::shared_ptr<ITEM> item) {
